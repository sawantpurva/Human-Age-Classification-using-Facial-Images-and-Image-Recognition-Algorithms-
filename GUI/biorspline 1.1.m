...
FM52_norm(img_count,1:22)=[(dc/1e+1) (b1/1e+3) (b2/1e+3) (b3/1e+2) (b4/1e+2) (b5/1e+3) (b6/1e+2) (b7/1e+2) (b8/1e+2) (b9/1e+1) (b10/1e+1) (b11/1e+1) (b12/1) (b13/1) (b14/1) (b15/1e-1) (b16/1e-1) (b17/1e-1) (b18/1e-2) (b19/1e-2) (b20/1e-2) (b21/1e-3)];
FM52(img_count,1:22)=round(FM52_norm(img_count,1:22));
end
