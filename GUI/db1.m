...
%Wavelet transform
[ca ch cv cd]=wt2(I,'db1');
[m n]=size(ch);
[ca1 ch1 cv1 cd1]=wt2(ca,'db1');
[m1 n1]=size(ch1);
[ca2 ch2 cv2 cd2]=wt2(ca1,'db1');
[m2 n2]=size(ch2);
[ca3 ch3 cv3 cd3]=wt2(ca2,'db1');
[m3 n3]=size(ch3);
[ca4 ch4 cv4 cd4]=wt2(ca3,'db1');
[m4 n4]=size(ch4);
[ca5 ch5 cv5 cd5]=wt2(ca4,'db1');
[m5 n5]=size(ch5);
[ca6 ch6 cv6 cd6]=wt2(ca5,'db1');
[m6 n6]=size(ch6);
...
FM1(img_count,1:22)=[(dc/1e+4) (b1/1e+6) (b2/1e+6) (b3/1e+5) (b4/1e+6) (b5/1e+5) (b6/1e+5) (b7/1e+5) (b8/1e+5) (b9/1e+4) (b10/1e+4) (b11/1e+4) (b12/1e+3) (b13/1e+3) (b14/1e+3) (b15/1e+2) (b16/1e+2) (b17/1e+2) (b18/1e+1) (b19/1e+1) (b20/1e+1) (b21/1e+1)];
FM1_gau(img_count,1:22)=round(FM1(img_count,1:22));
end
